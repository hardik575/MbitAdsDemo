...
public class TemplateViewForHome extends FrameLayout {
    ...
    public TemplateViewForHome(Context context) {
        super(context);
    }

    public TemplateViewForHome(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs);
    }

    public TemplateViewForHome(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initView(context, attrs);
    }

    public TemplateViewForHome(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
