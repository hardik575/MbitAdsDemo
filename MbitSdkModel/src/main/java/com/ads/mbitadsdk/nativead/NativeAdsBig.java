...
public class NativeAdsBig {
    ...
    public NativeAdsBig(Context mContext, LifecycleOwner lifecycleOwner, boolean isReloadAds, String admobNativeAdId, NativeAdLoadCallback nativeAdLoadCallback) {
