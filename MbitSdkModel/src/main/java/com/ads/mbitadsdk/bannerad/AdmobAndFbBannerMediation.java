...
public class AdmobAndFbBannerMediation {
    ...
    String TAG = "BANER CALL";

    LifecycleOwner lifecycleOwner;


    public AdmobAndFbBannerMediation(Context cntx, LifecycleOwner lifecycleOwner, String admobBannerId, String isCollapsing, boolean isReloadAds) {
        this.mContext = cntx;
